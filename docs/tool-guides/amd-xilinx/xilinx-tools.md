...
!!! warning
    ...
    The information on this page applies to the latest **December 17, 2025**. Flag behavior and availability may change in other releases.

For up-to-date definitions, refer to the official AMD/Xilinx documentation.
...
- [(UG937) Vivado Design Suite Tutorial: Logic simulation](https://docs.amd.com/viewer/book-attachment/AQgD74oGsbut9Xk6PJxfeg/ru_jonSSGpL1ZaPwb3D3cA-AQgD74oGsbut9Xk6PJxfeg)
- [(UG906) Vivado Design Suite User Guide: Design Analysis and Closure Techniques](https://docs.amd.com/viewer/book-attachment/HKXDYGChb9XYiCDCLp4tqA/1UwxVI3GMJjdVgdG3TrZBQ-HKXDYGChb9XYiCDCLp4tqA)
